...
app.layout = html.Div([
             ...
             html.Div(dcc.Dropdown( id='select-year', options=[{'label': i, 'value': i} for i in year_list],
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        unemp_eff= recession_data.groupby(['Vehicle_Type','unemployment_rate'])['Automobile_Sales'].mean().reset_index()
        R_chart4 = dcc.Graph(
            figure=px.bar(unemp_eff,
            x='unemployment_rate', 
            y='Vehicle_Type', 
